export const SERVER_URL = 'http://192.168.7.115:3001/api/'; //your computer current address IP
// export const SERVER_URL = 'http://10.0.2.2:3001/api/'; //localhost for emulator
